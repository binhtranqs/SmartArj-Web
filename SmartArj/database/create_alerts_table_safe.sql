-- SAFE script to create Alerts table and insert data dynamically
...
BEGIN
    ...
    INSERT INTO Zones (ZoneName, CityName, Latitude, Longitude, Area)
    VALUES ('Default Zone', 'Hanoi', 21.0, 105.8, 100);
    SET @Zone1 = SCOPE_IDENTITY();
    SET @Zone2 = @Zone1; -- Use same ID if only one exists
    SET @Zone3 = @Zone1;
END
