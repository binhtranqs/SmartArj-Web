                    ...
                    <form method="POST" action="${pageContext.request.contextPath}/register">
                        ...
                        <div class="form-group">
                            ...
                            <select name="cityId" class="form-input" required>
                                ...
                                <% java.util.List<Object[]> cities =
                                    (java.util.List<Object[]>) request.getAttribute("cities");
                                        if (cities != null) {
                                        for (Object[] city : cities) {
                                        String cid = city[0].toString();
                                        String name = city[1] != null ? city[1].toString() : "";
                                        %>
                                        <option value="<%= cid %>">
                                            <%= name %>
                                        </option>
                        ...
                        <div class="form-checkbox">
                            ...
                            <label for="agree"
                                ...
                                Tôi đồng ý với <a href="#" style="color: #2D6A4F;">Điều khoản sử dụng</a>
                                và <a href="#" style="color: #2D6A4F;">Chính sách bảo mật</a>
                            </label>
                        </div>
