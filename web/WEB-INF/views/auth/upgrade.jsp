            ...
            <div class="page-container">
                ...
                <% if (request.getAttribute("error") !=null) { %>
                    ...
                    <% } %>
                        ...
                        <% if (currentUser !=null) { %>
                            <div class="card mb-4"
                                style="padding: 2rem; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white;">
                            ...
                            <% } %>
                                ...
                                <div class="grid grid-3 mb-4">
                                    ...
                                    <div class="card card-hover-lift" style="padding: 2rem; text-align: center;">
                                        ...
                                        <div
                                            style="font-size: 2.5rem; font-weight: 700; color: #667eea; margin: 1rem 0;">
                                            99,000đ
                                        </div>
                                    ...
                                    <div class="card card-hover-lift"
                                        style="padding: 2rem; text-align: center; border: 3px solid #667eea; position: relative;">
                                        <div
                                            style="position: absolute; top: -15px; left: 50%; transform: translateX(-50%); background: #667eea; color: white; padding: 0.25rem 1rem; border-radius: 999px; font-size: 0.75rem; font-weight: 700;">
                                            PHỔ BIẾN NHẤT
                                        </div>
                                        <div style="font-size: 3rem; margin-bottom: 1rem;">🔥</div>
